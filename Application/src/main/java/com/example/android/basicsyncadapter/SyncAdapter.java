...
class SyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    private MyBoradcastReciever myBoradcastReciever;
    //private static final String FEED_URL = "http://android-developers.blogspot.com/atom.xml";
    private static final String FEED_URL = "https://api.flickr.com/services/feeds/photos_public.gne?format=xml";
     ...
     * the sync.
     */
    //TODO syncResult если не получилась синхронизация, то перенести как только устройство
    //TODO будет включено при условии что есть  WiFi сеть, если сети нет то синхронизация
    //TODO должна начинаться после запуска приложения пользователем.
    ...
    public void onPerformSync(Account account, Bundle extras, String authority,
        ...
        try {
            ...
            if(syncResult.hasError()&&isOnline(getContext())){

                IntentFilter screenStateFilter = new IntentFilter();
                screenStateFilter.addAction(Intent.ACTION_SCREEN_ON);
                myBoradcastReciever = new MyBoradcastReciever();
                getContext().registerReceiver(myBoradcastReciever, screenStateFilter);

            }else if (myBoradcastReciever != null) {

                getContext().unregisterReceiver(myBoradcastReciever);
                myBoradcastReciever = null;
            }
        }
